...
const SingleBlog = () => {
    ...
    return (
        <div className='flex w-10/12 m-auto'>
            <div className='mt-14 w-9/12 p-5'>
                ...
                <img className='mt-6' src={imageURL} alt="" />
                <p className='mt-8'>{description}</p>
                <h2 className='text-2xl font-black mt-3'>More About The Topic</h2>
                <p className='mt-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis quo error inventore voluptates asperiores. Et laborum sed provident. Perspiciatis, itaque?</p>
            </div>
            <div className='w-2/12 ml-3 mt-60'>
